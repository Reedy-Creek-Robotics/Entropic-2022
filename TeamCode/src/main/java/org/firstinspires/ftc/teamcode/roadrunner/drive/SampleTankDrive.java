...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        if (DriveConstants.RUN_USING_ENCODER && DriveConstants.DRIVE_MOTOR_VELO_PID != null) {
            setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, DriveConstants.DRIVE_MOTOR_VELO_PID);
        }
