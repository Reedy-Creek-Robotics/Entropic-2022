        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case TUNING_MODE:
                    ...
                    double targetPower = Kinematics.calculateMotorFeedforward(motionState.getV(), motionState.getA(), driveTrain.driveTuner.kv, driveTrain.driveTuner.ka, driveTrain.driveTuner.kStatic);
